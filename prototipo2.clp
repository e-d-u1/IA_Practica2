...
(definstances instances
   ...
   ([CasaAuto15] of ViviendaVertical
       (id oAuto15)
       (precio 886)
       (habitaciones 4)
       (superficie 96)
   ...
   ([CasaAuto20] of ViviendaVertical
       (id oAuto20)
       (precio 1510)
       (habitaciones 3)
       (superficie 73)
   ...
   ([CasaAuto21] of ViviendaVertical
       (id oAuto21)
       (precio 2373)
       (habitaciones 3)
       (superficie 121)
   ...
   ([CasaAuto26] of ViviendaVertical
       (id oAuto26)
       (precio 1272)
       (habitaciones 5)
       (superficie 48)
   ...
   ([CasaAuto27] of ViviendaVertical
       (id oAuto27)
       (precio 747)
       (habitaciones 3)
       (superficie 72)
   ...
   ([CasaAuto28] of ViviendaVertical
       (id oAuto28)
       (precio 1418)
       (habitaciones 1)
       (superficie 81)
   ...
   ([CasaAuto32] of ViviendaVertical
       (id oAuto32)
       (precio 994)
       (habitaciones 2)
       (superficie 49)
   ...
   ([CasaAuto36] of ViviendaVertical
       (id oAuto36)
       (precio 2377)
       (habitaciones 1)
       (superficie 71)
   ...
   ([CasaAuto48] of ViviendaVertical
       (id oAuto48)
       (precio 1614)
       (habitaciones 5)
       (superficie 130)
   ...
   ([CasaAuto53] of ViviendaVertical
       (id oAuto53)
       (precio 1208)
       (habitaciones 2)
       (superficie 134)
   ...
   ([CasaAuto56] of ViviendaVertical
       (id oAuto56)
       (precio 784)
       (habitaciones 4)
       (superficie 103)
   ...
   ([CasaAuto57] of ViviendaVertical
       (id oAuto57)
       (precio 1976)
       (habitaciones 5)
       (superficie 68)
   ...
   ([CasaAuto82] of ViviendaVertical
       (id oAuto82)
       (precio 828)
       (habitaciones 3)
       (superficie 144)
   ...
   ([CasaAuto93] of ViviendaVertical
       (id oAuto93)
       (precio 690)
       (habitaciones 3)
       (superficie 113)
